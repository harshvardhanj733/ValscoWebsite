  ...
  return (
    <>
      ...
      <div className="login-div">
        <img src={require("../../../components/images/login-image.png")} id="login-img" alt="login-img" />
        <h1>Login</h1>
        ...
        >
          <img src={require("../../../components/images/google-image.png")} id="google-img" className="mx-2" />
